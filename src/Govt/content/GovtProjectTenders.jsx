            ...
            <div className="">
                ...
                <table className="border-collapse font-sans w-[98.2%] m-3 ">
                    <tr className="font-bold text-[#213361]">
                        <th className="border pt-3 pb-3s" >Tender ID</th>
                        ...
                        <th className="border pt-3 pb-3s" >Comapany</th>
                        <th className="border pt-3 pb-3s" >Tendering Date</th>
                        <th className="border pt-3 pb-3s" >View/Approve/Delete</th>
                    </tr>
                    ...
                    <tr className="text-center">
                        ...
                        <td className="border pt-3 pb-3 ">
                            <div className="flex align-middle w-full justify-center items-center gap-8">
                                <Link to={'tenderdetails'}><GrView color="#213361" size={25} /></Link>
                                <Link to={'tenderdetails'}><FaRegCheckCircle   color="green" size={25} /></Link>
