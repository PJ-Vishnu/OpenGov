function CreateCompanyAdminP2({ handleChangeEvent, formdata, handleSubmit }) {
    return (
        <div className="flex flex-col w-11/12">
            ...
            <br />
            <button onClick={handleSubmit} className="bg-[#213361] text-white rounded-lg w-auto h-auto p-3 pl-5 pr-5 self-center">Create Company</button>
        </div>
    )
}
