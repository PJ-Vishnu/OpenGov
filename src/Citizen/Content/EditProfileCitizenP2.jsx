function EditProfileCitizenP2() {
    return (
        <div className="flex flex-col w-11/12">
            ...
            <textarea name="address" id="" cols="30" rows="10" placeholder="Enter your Home Address" className="border-[2px] border-[#213361] rounded-lg w-full h-20 pl-3"></textarea>
            <br />
...
export default EditProfileCitizenP2