function SignUpPage2Company() {
    return (
                <div className="flex flex-col w-11/12">
                    ...
                    <textarea name="company_details" id="" cols="30" rows="10" className="border-[2px] border-[#213361] rounded-lg w-full h-20 pl-3"></textarea>
                    <br />
...
export default SignUpPage2Company