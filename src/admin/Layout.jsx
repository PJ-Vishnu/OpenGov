                ...
                <div className="fixed rounded-[20px] flex m-3 w-1/5 h-[88.7vh] bg-[#213361] text-[32px] justify-center ">
                    <div className="w-full">
                        <ul>
                            ...
                            <li onClick={()=>setSelectLink('citizen')} ><Link to={'/admin/citizen'}><div className={`${selectLink === 'citizen' ? 'ms-3 mt-3 mb-3 -me-5' : 'm-3'} flex justify-center bg-white rounded-[20px] p-2 text-[#213361]`}><img src="" alt="" /><b>citizens</b></div></Link></li>
